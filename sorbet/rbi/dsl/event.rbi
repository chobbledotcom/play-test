...
class Event
  ...
  module GeneratedAttributeMethods
    ...
    sig { returns(T.untyped) }
    def changed_data; end

    sig { params(value: T.untyped).returns(T.untyped) }
    def changed_data=(value); end

    sig { returns(T::Boolean) }
    def changed_data?; end

    sig { returns(T.untyped) }
    def changed_data_before_last_save; end

    sig { returns(T.untyped) }
    def changed_data_before_type_cast; end

    sig { returns(T::Boolean) }
    def changed_data_came_from_user?; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def changed_data_change; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def changed_data_change_to_be_saved; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def changed_data_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.untyped) }
    def changed_data_in_database; end

    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def changed_data_previous_change; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def changed_data_previously_changed?(from: T.unsafe(nil), to: T.unsafe(nil)); end

    sig { returns(T.untyped) }
    def changed_data_previously_was; end

    sig { returns(T.untyped) }
    def changed_data_was; end

    sig { void }
    def changed_data_will_change!; end
    ...
    sig { returns(T.nilable([T.untyped, T.untyped])) }
    def saved_change_to_changed_data; end

    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def saved_change_to_changed_data?(from: T.unsafe(nil), to: T.unsafe(nil)); end
    ...
    sig { params(from: T.untyped, to: T.untyped).returns(T::Boolean) }
    def will_save_change_to_changed_data?(from: T.unsafe(nil), to: T.unsafe(nil)); end
