...
RSpec.describe ChobbleApp::Page, type: :model do
  describe "validations" do
    it "requires slug to be present" do
      page = ChobbleApp::Page.new(link_title: "Test", content: "Test content")
    ...
    it "requires link_title to be present" do
      page = ChobbleApp::Page.new(slug: "test", content: "Test content")
      expect(page).not_to be_valid
      expect(page.errors[:link_title]).to include("can't be blank")
    end

    it "requires content to be present" do
      page = ChobbleApp::Page.new(slug: "test", link_title: "Test")
      expect(page).not_to be_valid
  ...
  describe "#to_param" do
    it "returns the slug" do
      page = ChobbleApp::Page.new(slug: "test-page")
