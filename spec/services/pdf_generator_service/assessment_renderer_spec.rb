...
RSpec.describe PdfGeneratorService::AssessmentRenderer do
  ...
  describe "#group_assessment_fields" do
    it "groups related fields together" do
      field_keys = %i[
        num_low_anchors
        num_low_anchors_pass
        num_low_anchors_comment
        num_high_anchors_pass
  ...
  describe "full field group rendering" do
    ...
    it "renders field with value, pass status, and comment on separate lines" do
      assessment.update!(
        ...
        num_low_anchors_comment: "Need 2 more anchors for this size unit"
      )

      fields = {
        base: :num_low_anchors,
        pass: :num_low_anchors_pass,
        comment: :num_low_anchors_comment
      }

      renderer.send(:render_field_group, "num_low_anchors", fields)
