...
module ViewHelpers
  ...
  sig { params(field_name: String, type: T.nilable(String)).void }
  ...
  sig { params(i18n_base_or_options: T.any(String, T::Hash[Symbol, String])).void }
  ...
  sig { params(field_identifier: String, value: String, by: Symbol).void }
  ...
  sig { params(user: T.nilable(User)).returns User }
  ...
  sig { params(i18n_key: String, options: T::Hash[Symbol, T.untyped]).void }
  ...
  sig { params(i18n_base: String).void }
  ...
  sig { params(legend_text: String).void }
  ...
  sig { params(model_name: String, field_names: T::Array[String]).void }
  ...
  sig { params(model: T.untyped, attributes: Symbol).void }
  ...
  sig { params(field: Symbol, label: T.nilable(String), options: T.untyped).returns T::Hash[Symbol, T.untyped] }
  ...
  sig { params(field_type: Symbol, field_name: Symbol, rendered_html: String).void }
  ...
  sig { params(field_name: Symbol, label_text: String).void }
  ...
  sig { params(partial_name: String, locals: T::Hash[Symbol, T.untyped]).void }
  ...
  sig { params(field_name: Symbol, label_text: String, type: String).void }
  ...
  sig { params(field_method: Symbol, input_type: String).void }
  ...
  sig { params(text: String, href: T.nilable(String)).void }
  ...
  sig { params(text: String, method: T.nilable(Symbol), confirm: T::Boolean).void }
  ...
  sig { params(field_name: String, checked: T::Boolean).void }
  ...
  sig { params(field_name: String, options: T::Array[String]).void }
