...
module FormHelpers
  ...
  sig do
    params(
      form_name: Symbol,
      field_name: Symbol,
      value: T.any(String, Float, Date, Integer)
    ).void
  end
  ...
  sig { params(form_name: Symbol, block: T.proc.void).void }
  def within_form(form_name, &block)
    form_header = I18n.t "forms.#{form_name}.header"
    within(".calculator-form", text: form_header, &block)
  end

  sig { params(form_name: Symbol, field_name: Symbol, value: T.any(String, Float)).void }
  ...
  sig { params(form_name: Symbol).void }
  ...
  sig { params(form_name: Symbol, field_name: Symbol).void }
  ...
  sig { params(form_name: Symbol, field_name: Symbol).returns T.untyped }
  ...
  sig { params(form_selector: String, i18n_base: String).void }
  ...
  sig { params(form_name: Symbol, count: T.nilable(Integer)).void }
  ...
  sig { params(key: String, interpolations: T.untyped).void }
  ...
  sig { params(form_name: Symbol, field_name: Symbol, value: T.untyped).void }
  ...
  sig { params(form_name: Symbol, field_name: Symbol).returns String }
  ...
  # Assessment helpers
  sig { params(assessment_type: Symbol, data: T::Hash[Symbol, T.untyped]).void }
  ...
  sig { params(inspection: Inspection, assessment_type: String).void }
  ...
  sig { params(form_name: Symbol, field_name: Symbol, value: String).void }
  ...
  sig { params(tab_name: Symbol, has_check: T::Boolean).void }
  ...
  sig { params(user_data: T::Hash[Symbol, T.untyped], activate: T::Boolean).returns User }
  ...
  sig { params(name: String, attributes: T.untyped).returns Unit }
  ...
  sig { params(unit: Unit).returns T.nilable(Inspection) }
