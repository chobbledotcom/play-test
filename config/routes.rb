...
#       inspection_ball_pool_assessment PATCH    /inspections/:inspection_id/ball_pool_assessment(.:format)                                        ball_pool_assessments#update
#                                       PUT      /inspections/:inspection_id/ball_pool_assessment(.:format)                                        ball_pool_assessments#update
# inspection_inflatable_game_assessment PATCH    /inspections/:inspection_id/inflatable_game_assessment(.:format)                                  inflatable_game_assessments#update
#                                       PUT      /inspections/:inspection_id/inflatable_game_assessment(.:format)                                  inflatable_game_assessments#update
#       inspection_catch_bed_assessment PATCH    /inspections/:inspection_id/catch_bed_assessment(.:format)                                        catch_bed_assessments#update
#                                       PUT      /inspections/:inspection_id/catch_bed_assessment(.:format)                                        catch_bed_assessments#update
#          inspection_bungee_assessment PATCH    /inspections/:inspection_id/bungee_assessment(.:format)                                           bungee_assessments#update
#                                       PUT      /inspections/:inspection_id/bungee_assessment(.:format)                                           bungee_assessments#update
#       inspection_play_zone_assessment PATCH    /inspections/:inspection_id/play_zone_assessment(.:format)                                        play_zone_assessments#update
#                                       PUT      /inspections/:inspection_id/play_zone_assessment(.:format)                                        play_zone_assessments#update
