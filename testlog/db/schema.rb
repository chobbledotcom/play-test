...
ActiveRecord::Schema[8.0].define(version: 2025_05_18_184611) do
  ...
  create_table "equipment", id: { type: :string, limit: 12 }, force: :cascade do |t|
    t.string "name"
    t.string "location"
    t.string "serial"
    ...
    t.index ["serial"], name: "index_equipment_on_serial"
