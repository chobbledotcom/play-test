...
class ComprehensivePdfGeneratorService
  ...
  def self.add_images(pdf, inspection)
    ...
    if inspection.unit&.images&.attached?
      # TODO: Add unit image
      # pdf.image inspection.unit.images.first, at: [0, 0], width: 128, height: 95
    end
    
    # Inspector company logo (below unit photo)
    if inspection.inspector_company&.logo&.attached?
      # TODO: Add company logo
      # pdf.image inspection.inspector_company.logo, at: [0, 100], width: 128, height: 95
    end
  end
