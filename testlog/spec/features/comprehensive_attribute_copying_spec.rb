...
RSpec.feature "Comprehensive Attribute Copying Between Units and Inspections", type: :feature do
  ...
  describe "Unit -> Inspection attribute copying" do
    let(:comprehensive_unit) {
      create(:unit,
        ...
        # Slide dimensions (since has_slide: true)
        ...
        # Enclosed dimensions (since is_totally_enclosed: true)
        exit_number: 3,
    ...
    scenario "Creating inspection from unit copies all attributes" do
      ...
      expect(inspection.unit).to eq(comprehensive_unit)
      ...
      expect(inspection.user_height).to eq(1.8)
  ...
  describe "Inspection -> Unit attribute copying" do
    let(:comprehensive_inspection) {
      create(:inspection,
        user: user,
        unit: nil, # No unit initially
        inspector_company: inspector_company,
        inspection_location: "Test Location",
        
        # All the same comprehensive attributes as the unit test above
        width: 15.0,
        length: 12.0,
        height: 5.0,
